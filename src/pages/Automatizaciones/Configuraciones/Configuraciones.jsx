...
// ============================================================================
//  ContenidoConfiguraciones — Panel de configuraciones de la app
//  Sección: Tema/Color de la aplicación con color picker custom
// ============================================================================
...
export default function ContenidoConfiguraciones() {
  ...
  return (
    <div className="cfg-container">
      ...
      <div className="cfg-header">
        ...
        <div>
          <h2 className="cfg-header-title">Configuraciones</h2>
