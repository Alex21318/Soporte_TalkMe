...
router.post('/api/skills/usuario/permiso', async (req, res) => {
    const { db_key, id_usuario, id_skill, creado_por } = req.body;
    ...
    try {
        ...
        await pools[db_key].query(
            ...
            [id_usuario, id_skill, creado_por || 'alex.carrrera']
        );
...
router.delete('/api/skills/usuario/permiso/:idUsuario/:idSkill', async (req, res) => {
